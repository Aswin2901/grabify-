...
SECRET_KEY = 'django-insecure-acwy*bq3b_6r3=h)#p+xu5a)+dmcnbdclk^7^fckw8o(rop#)('
...
AUTH_USER_MODEL = 'grabify.CustomUser'
LOGIN_URL = '/login/'
...
PAYPAL_RECEIVER_EMAIL = 'busnesscustom@gmail.com'
